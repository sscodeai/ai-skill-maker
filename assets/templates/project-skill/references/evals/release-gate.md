# {{projectDisplayName}} Release Gate
...
not ready for the claimed maintainer audience.
...
| Structure | `validate-project-skill.mjs` passes | | |
...
- A file existing, a structural check passing, and a maintainer receiving the
  desired result are different levels of evidence. Report only what was
  actually checked.
...
<!-- BEGIN USER RULES -->
<!-- Add durable project release-gate rules here. This block is preserved on refresh. -->
<!-- END USER RULES -->
